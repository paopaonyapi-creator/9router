...
// These audits grep source files. Resolve from this file's location, not the
// process cwd — running vitest from tests/ vs the repo root used to decide
// pass/fail on its own (ENOENT on tests/src/...).
