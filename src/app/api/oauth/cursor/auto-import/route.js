...
function extractTokensViaBetterSqlite(dbPath) {
  ...
  // Webpack resolves better-sqlite3 as an external here; under a plain ESM loader
  // (vitest) this throws, and the route falls through to the sqlite3 CLI strategy.
